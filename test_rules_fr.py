...
class FrenchRulesTest(unittest.TestCase):
    ...
    def test_get_dependent_sibling_info_no_conjunction(self):
        self.compare_get_dependent_sibling_info('Richard rentra à la maison', 0, '[]', None, False)

    def test_get_dependent_sibling_info_two_member_conjunction_phrase_and(self):
        self.compare_get_dependent_sibling_info('Richard et Christine rentrent à la maison', 0,
    ...
    def test_nominal_adjective(self):
        self.compare_independent_noun(
    ...
    def test_possessive_pronouns(self):
        self.compare_potential_anaphor('Ma maison, ta maison, sa maison, leur maison.', [6, 9])
    ...
    def test_potentially_definite_common_noun_conjunction_first_member(self):
        self.compare_potentially_definite('Je parlais avec cet homme et une femme', 4, True)

    def test_potentially_definite_common_noun_conjunction_second_member(self):
        self.compare_potentially_definite('Je parlais avec un homme et cette femme', 7, True)

    def test_potentially_definite_common_noun_conjunction_first_member_control(self):
        self.compare_potentially_definite('Je parlais avec l\'homme et une femme', 7, False)

    def test_potentially_definite_common_noun_conjunction_second_member_control(self):
        self.compare_potentially_definite('Je parlais avec un homme et la femme', 4, False)
    ...
    def test_potential_pair_trivial_plural(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Ils couraient', 3, True, 8, 2,
        excluded_nlps=['core_news_sm'])
    ...
    def test_potential_pair_plurals_with_coordination_first(self):
        self.compare_potential_pair('Je voyais des hommes et des femmes. Ils couraient', 3, False, 8, 0)

    def test_potential_pair_plurals_with_coordination_second(self):
        self.compare_potential_pair('Je voyais des hommes et des femmes. Ils couraient', 6, False, 8, 0)


    def test_potential_pair_trivial_possessive(self):
        self.compare_potential_pair('Je voyais un homme. Son chien courait', 3, False, 5, 2)

    def test_potential_pair_trivial_masc_possessive_control_1(self):
        self.compare_potential_pair('Je voyais un homme. Leur chien courait', 3, False, 5, 0)
    ...
    def test_potential_pair_trivial_plur_single_element(self):
        self.compare_potential_pair('Je voyais quelques femmes. Elles dormaient', 3, False, 5, 2)
    ...
    def test_potential_pair_trivial_plur_single_element_possessive(self):
        self.compare_potential_pair('Je voyais quelques femmes. Leur chien dormait', 3, False, 5, 2)

    def test_potential_pair_trivial_plur_single_element_possessive_control(self):
        self.compare_potential_pair('Je voyais quelques femmes. Son chien dormait', 3, False, 5, 0)

    def test_potential_pair_trivial_plur_coordination(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Ils dormaient', 3, True, 8, 2, 
        excluded_nlps=['core_news_sm'])
    ...
    def test_potential_pair_trivial_plur_coordination_control_2(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Elles dormaient', 3, True, 8, 0)

    def test_potential_pair_trivial_plur_coordination_possessive(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Leur chien dormait', 3, True, 8, 2)
        
    def test_potential_pair_trivial_plur_coordination_possessive_control(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Son chien dormaient', 3, True, 8, 0)
    ...
    def test_potential_pair_trivial_sing_coordination_first_element(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Il dormait', 3, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_first_element_control_1(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Elle dormait', 3, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_first_element_control_2(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Ils dormaient', 3, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_first_element_possessive(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Son chien dormait', 3, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_first_element_possessive_control(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Leur chien dormait', 3, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_second_element(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Elle dormait', 6, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_second_element_control_1(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Il dormait', 6, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_second_element_control_3(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Ils dormaient', 6, False, 8, 0)

    def test_potential_pair_trivial_sing_coordination_second_element_possessive(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Son chien dormait', 6, False, 8, 2)

    def test_potential_pair_trivial_sing_coordination_second_element_possessive(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Leur chien dormait', 6, False, 8, 0)
    
    def test_potential_pair_masc_trumps_et_control_1(self):
        self.compare_potential_pair('Je voyais un homme et une femme. Elles dormaient', 3, True, 8, 0)
    
    def test_potential_pair_masc_trumps_et_2(self):
        self.compare_potential_pair('Je voyais une femme et un homme. Ils dormaient', 3, True, 8, 2)
    ...
    def test_potential_pair_masc_trumps_ou_control_1(self):
        self.compare_potential_pair('Je voyais un homme ou une femme. Elle dormait', 3, True, 8, 0)
    
    def test_potential_pair_masc_trumps_ou_2(self):
        self.compare_potential_pair('Je voyais une femme ou un homme. Il dormait', 3, True, 8, 2)
    ...
    def test_potential_pair_apposition(self):
        self.compare_potential_pair('Alexandre, roi de Macédoine devient empereur. Il meurt à 33 ans.', 0, True, 8, 2,
        excluded_nlps = ['core_news_md','core_news_sm'])     
    
    def test_potential_pair_apposition_2(self):
        self.compare_potential_pair('Alexandre, roi de Macédoine devient empereur. Il meurt à 33 ans.', 2, True, 8, 2,
        excluded_nlps=['core_news_md','core_news_sm'])     
    ...
    def test_potential_pair_fem_acc_anaphor_2(self):
        self.compare_potential_pair('Je voyais quelques femmes. Je les salue', 3, False, 6, 2)
    ...
    def test_potential_pair_location_anaphor_1(self):
        self.compare_potential_pair('Je viens de France. C\'est là que j\'ai grandi',3 , False, 7, 2,
        excluded_nlps=['core_news_sm'])
        
    def test_potential_pair_location_anaphor_2(self):
        self.compare_potential_pair('J\'arrive en France. C\'est ici que je veux vivre',3 , False, 7, 2,
        excluded_nlps=['core_news_sm'])
    ...
    def test_potential_pair_group_part_en(self):
        self.compare_potential_pair('Je collectionne les billes. J\'en ai beaucoup.',3 , False, 6, 2,
        excluded_nlps=['core_news_sm'])
        
 
    def test_potential_pair_demonstrative_pronoun_closer(self):
        self.compare_potential_pair(
        'Les professeurs et les élèves sont arrivés. Ceux-ci sont bruyants.',4 , False, 8, 2,
        excluded_nlps=['core_news_sm'])
    ...
    def test_reflexive_with_conjuction(self):
        self.compare_potential_reflexive_pair('La maison et la voiture se surpassèrent',
            1, True, 5, 2, True, 2)
    ...
    def test_reflexive_with_passive_and_conjunction(self):
        self.compare_potential_reflexive_pair('La maison et la voiture furent achetées par elles-mêmes',
            1, True, 8, 2, True, 2)
    ...
    def test_reflexive_with_object_antecedent_and_coordination(self):
        self.compare_potential_reflexive_pair('Elle mélangea le produit et le sel avec eux-mêmes',
    ...
    def test_reflexive_double_coordination_with_preposition(self):
        self.compare_potential_reflexive_pair('Jean et Marie parlaient avec lui et avec elle.',
            0, False, 5, 0, True, 0, excluded_nlps=['core_news_sm'])
        self.compare_potential_reflexive_pair('Jean et Marie parlaient avec lui et avec elle.',
    ...
    def test_reflexive_relative_clause_subject_with_conjunction(self):
        self.compare_potential_reflexive_pair("L'homme et la femme qui les voyaient, sont rentrés",
            1, True, 6, 0, True, 0, excluded_nlps=['core_news_sm'])

    def test_reflexive_relative_clause_object_with_conjunction(self):
        self.compare_potential_reflexive_pair("L'homme et la femme qu'ils voyaient, sont rentrés",
            1, True, 6, 0, True, 0, excluded_nlps=['core_news_sm'])
    ...
    def test_cataphora_tokens_deeper_in_tree_1(self):
        self.compare_potential_cataphoric_pair(
            'Bien que tous ses fans parlaient de le voir, la presse avait depuis longtemps cessé de déranger Gérard.', 18 , False , 3, True,
            excluded_nlps=['core_news_sm'])
    def test_cataphora_tokens_deeper_in_tree_2(self):
        self.compare_potential_cataphoric_pair(
            'Bien que tous ses fans parlaient de le voir, la presse avait depuis longtemps cessé de déranger Gérard.', 18 , False , 7, True,
            excluded_nlps=['core_news_sm'])
            
    def test_cataphora_tokens_deeper_in_tree_conjunction_1(self):
        self.compare_potential_cataphoric_pair(
        'Bien que tous leurs fans parlaient de les voir, la presse avait depuis longtemps cessé de déranger Gérard et Hélène.', 18, True, 3, True,
        excluded_nlps=['core_news_sm'])
    def test_cataphora_tokens_deeper_in_tree_conjunction_2(self):
        self.compare_potential_cataphoric_pair(
        'Bien que tous leurs fans parlaient de les voir, la presse avait depuis longtemps cessé de déranger Gérard et Hélène.', 18, True, 7, True,
        excluded_nlps=['core_news_sm'])

    def test_cataphora_tokens_deeper_in_tree_conjunction_control(self):
        self.compare_potential_cataphoric_pair(
            'Bien que tous leurs fans parlaient de les voir, la presse avait depuis longtemps cessé de déranger Gérard et Hélène.', 18, False, 7, False)

    def test_cataphora_wrong_structure_1(self):
        self.compare_potential_cataphoric_pair(
            'La presse avait depuis longtemps cessé de le suivre, bien que tous ses fans parlaient de voir Gérard', 18, False, 7, False)
    ...
    def test_potential_referreds_maximum_sentence_referential_distance(self):
        self.compare_potential_referreds(
            "Richard vint. Un homme. Un homme. Un homme. Un homme. Il chuchota.", 15,
    ...
    def test_potential_noun_pair_proper_noun_test(self):
        self.compare_potential_noun_pair('De Bach à Beethoven, Brahms et Mozart',
            5, 7, False)
    '''
    Needs word list of types of noun
    ...
    def test_potential_noun_pair_apposition_same_lemma(self):
        self.compare_potential_noun_pair('Un roi de Macédoine devient empereur. Le roi de Macédoine meurt à 33 ans.',
            1, 8, True)     
                             
    def test_potential_noun_pair_proper_noun_noun(self):
        self.compare_potential_noun_pair('EDF existe depuis 20 ans. La compagnie a plusieurs fois changé de nom.',
            0, 7, True)
    def test_potential_noun_pair_proper_noun_noun_control(self):
        self.compare_potential_noun_pair('EDF existe depuis 20 ans. La femme a plusieurs fois changé de nom.',
            0, 7, False)   
            
    def test_potential_noun_pair_proper_definite_noun_relative_clause(self):
        self.compare_potential_noun_pair('Le roi que tu as vu est arrivé. Ce roi s\'appelle Alexandre',
            1, 10, True)   
